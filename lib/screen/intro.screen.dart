  ...
  Widget build(BuildContext context) {
    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          title: "Hi, there",
          body: "Welcome to ngontrakkan, in here you will easy to find house for rent",
          image: introImage('assets/images/background/welcome-marker.png'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Easy explorer",
          body: "Let go start to find house for rent",
          image: introImage('assets/images/background/location-marker.png'),
          decoration: pageDecoration,
        ),
